        ...
        rows.append(
            {
                ...
                "sentence_in_paragraph": int(finding.get("sentence_in_paragraph", 0)),
                "is_paragraph_first": bool(finding.get("is_paragraph_first", False)),
                "is_paragraph_last": bool(finding.get("is_paragraph_last", False)),
                "paragraph_kind": str(finding.get("paragraph_kind", "unknown")),
                "section_heading": str(finding.get("section_heading", "")),
                "is_document_last": bool(finding.get("is_document_last", False)),
                "body_paragraphs_to_end": int(finding.get("body_paragraphs_to_end", 0)),
                "shape": str(finding.get("shape", "")),
